...
class CompanyDashboard extends Component{
	render(){
		...
		const companyHeader = `${companyData.companyName}`;

		const panes = [
		  	{ menuItem: 'Company News', render: () => <Tab.Pane className="panes"><News data={companyNews}/></Tab.Pane> },
		  	{ menuItem: 'Balance Sheet Analysis', render: () => <Tab.Pane className="panes"><BalanceSheet data={balanceSheet}/></Tab.Pane> },
		  	{ menuItem: 'Income Statement Analysis', render: () => <Tab.Pane className="panes"><IncomeStatement data={income}/></Tab.Pane> },
		  	{ menuItem: 'Cash Flow Analysis', render: () => <Tab.Pane className="panes" data={cashFlow}>Cash Flow Analaysis</Tab.Pane> }

		];		

		const switchTabs = () => <Tab className ="PANE" panes={panes} />
		return(
			<div>
